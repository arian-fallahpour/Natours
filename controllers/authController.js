...
exports.signup = catchAsync(async (req, res, next) => {
  // REPLACE to cope with security flaw
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // password is the password that the user sends, user.password is the encrypted password in the database
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // This travels from middleware to middleware
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  // 1) Gwt user based on POSTed email
  ...
  try {
    ...
    return next(
      new AppError("The was an error sending the email. Try again later!", 500)
    );
  }
