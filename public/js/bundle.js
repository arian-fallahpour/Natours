...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYXJpYW5mYWxsYWgiLCJhIjoiY2tneWQya3cwMDFzNjJ0bWpmbzRkbjB1YiJ9.gcpjPb9mYTriYLrzSZsjCw";
  var map = new mapboxgl.Map({
    container: "map",
    // puts a map on the element with and id of 'map'
    style: "mapbox://styles/arianfallah/ckgydywb17ybn19mayvb4bwty",
    scrollZoom: false //   center: [-118.107578, 34.100834],
    //   zoom: 4,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); // Add popu
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51HsuG3FLAxDYFFp8ZlsB7yDGTRRlWM5CZB7rdRc7P5aW1a3gRsif87eq048Qm1zvgrg3KlH0X1Qq5fFbXBsnknam00bgem2bJR");
            _context.prev = 1;
            _context.next = 4;
